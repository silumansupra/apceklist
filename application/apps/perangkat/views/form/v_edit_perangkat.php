      ...
      <div class="row">
       ...
       <div class="col-md-8">
        <h4>Data Kegiatan Pengukuran & Variabel
         <button type="button" class="btn btn-info btn-xs pull-right" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> Tambah Data</button>
        </h4>
        <div class="ln_solid"></div>
          ...
          <?php
            ...
            foreach ($dakeg as $r) {
             ...
             <tr>
              ...
              <td class="aksi">
               <a title="Edit" href="#" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i></a>
               <a title="Hapus" href="#" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
              </td>
             </tr>
            <?php } ?>
         </tbody>
        ...
        <div class="col-md-12">
         ...
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input type="text" name="tolak_ukur" id="nama_kegiatan" placeholder="Nama kegiatan" class="form-control" required>
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input type="text" name="var1" id="var1" placeholder="Variabel ceklist #1" class="form-control" required>
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input type="text" name="var2" id="var2" placeholder="Variabel ceklist #2" class="form-control">
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input type="text" name="var3" id="var3" placeholder="Variabel ceklist #3" class="form-control">
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input type="text" name="var4" id="var4" placeholder="Variabel ceklist #4" class="form-control">
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input type="text" name="var5" id="var5" placeholder="Variabel ceklist #5" class="form-control">
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <textarea name="ket_kegiatan" id="ket_kegiatan" placeholder="Ketereangan kegiatan..." class="form-control" rows="3"></textarea>
           </div>
          </div>
         </div>
         <div class="form-group">
