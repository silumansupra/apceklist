   ...
   <section class="content">
    ...
    <div class="box">
     <div class="box-header with-border">
      <h3 class="box-title">
       <i class="fa fa-plus"></i> FORM TAMBAH ASMAN
      </h3>
      <?= btnBantuan() ?>
     </div>
     <div class="box-body">
        ...
        <form action="<?php echo base_url() . "setting/asman/tambah" ?>" method="post">
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input type="text" name="nama_asman" id="nama_asman" placeholder="Nama lengkap" class="form-control" required>
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <input name="nik_asman" id="nik_asman" placeholder="Nomor Induk Karyawan" type="text" class="form-control">
           </div>
          </div>
         </div>
         <div class="form-group">
          <div class="row">
           ...
           <div class="col-md-9">
            <select name="status_asman" id="status_asman" class="form-control">
